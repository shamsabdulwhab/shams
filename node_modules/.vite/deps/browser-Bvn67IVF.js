...
function parseAlpha(input) {
	...
	if (!input) return defaultAlpha$1;
...
//#endregion
export { AlterType, AnimatableColor, AnimationOptions, AnimationStatus, Circle, CollisionMode, DestroyType, DivType, InteractorType, OptionsColor, OutMode, OutModeDirection, ParticleOutType, PixelMode, Rectangle, StartValueType, ValueWithRandom, Vector, arrayRandomIndex, calcPositionOrRandomFromSize, calcPositionOrRandomFromSizeRanged, calculateBounds, circleBounce, circleBounceDataFromParticle, clamp, colorMix, deepExtend, defaultAlpha, defaultAngle, degToRad, divMode, divModeExecute, double, doublePI, drawLine, errorPrefix, executeOnSingleOrMultiple, getDistance, getDistances, getHslAnimationFromHsl, getLinkColor, getLinkRandomColor, getLogger, getPosition, getRandom, getRangeMax, getRangeMin, getRangeValue, getSize, getStyleFromHsl, getStyleFromRgb, half, hslToRgb, hslaToRgba, initParticleNumericAnimationValue, isArray, isDivModeEnabled, isFunction, isInArray, isNull, isNumber, isObject, isPointInside, isSsr, isString, itemFromArray, itemFromSingleOrMultiple, loadFont, loadParticlesOptions, millisecondsToSeconds, mouseDownEvent, mouseLeaveEvent, mouseMoveEvent, none, originPoint, parseAlpha, percentDenominator, randomInRange, rangeColorToHsl, rangeColorToRgb, rectBounce, rgbToHsl, safeMatchMedia, setRangeValue, stringToAlpha, touchStartEvent, tsParticles, updateAnimation, updateColor };
//# sourceMappingURL=browser-Bvn67IVF.js.map